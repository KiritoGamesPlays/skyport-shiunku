...
async function getSMTPSettings() {
  ...
  const name = await db.get('name') || 'Shiunku';
  let secure = true
  if (!smtpSettings) {
      ...
      html: `
        <html>
          ...
          <body>
            <div class="container">
              <div class="header">
                <h2>Welcome to ${await db.get('name') || 'Shiunku'}!</h2>
              </div>
              <div class="content">
                <p>Dear ${username},</p>
                ...
                <p>We hope you enjoy using ${await db.get('name') || 'Shiunku'}!</p>
              </div>
              <div class="footer">
                            ...
                            <tr>
                              <td style="font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; color: #AEAEAE; padding: 35px; text-align: center;">
                                <p style="margin-top: 0; color: #74787E; font-size: 12px; line-height: 1.5em;">
                                  &copy; ${new Date().getFullYear()} ${await db.get('name') || 'Shiunku'}
                                </p>
                              </td>
                            </tr>
                          </table>
